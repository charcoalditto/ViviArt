...
namespace ViviArt.Droid
{
    ...
    public class MandalaArtProvider : AppWidgetProvider
    {
        ...
        public static void SetModePref(Context context, int appWidgetId, string modeType)
        {
            ...
            options.PutString(PREF_MODE, modeType);
